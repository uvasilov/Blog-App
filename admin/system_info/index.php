...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-navy">
		<div class="card-header">
			<h5 class="card-title">Жүйелік ақпарат</h5>
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Жүйенің есімі</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Жүйенің қысқа есімі</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Жүйелік логотип</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile1" name="img" onchange="displayImg(this,$(this))">
	              <label class="custom-file-label" for="customFile1">Файлды таңдау</label>
	            </div>
			</div>
			...
			<div class="form-group">
				<label for="" class="control-label">Вебсайт фоны</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile2" name="cover" onchange="displayImg2(this,$(this))">
	              <label class="custom-file-label" for="customFile2">Файлды жүктеу</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
			...
			<div class="form-group">
				<label for="" class="control-label">Карусель фотолары</label>
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">Файлды жүктеу</label>
	            </div>
				<small><i>Жаңа баннер суреттерін жүктеп салуды таңдаңыз.</i></small>
			</div>
			<?php 
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Жаңарту</button>
				</div>
			</div>
		</div>

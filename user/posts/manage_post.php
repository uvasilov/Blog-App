...
<div class="container-fluid">
	<form action="" id="post-form">
		...
		<div class="form-group mb-3">
			<label for="caption" class="control-label">Тақырыбы</label>
			...
			<div id="upload-images" class="mt-4">
				<h4 class="font-weight-bolder" id="upload-text">Фотоларды осында салыңыз</h4>
				...
				<button id='select-upload' class='btn btn-primary bg-gradient-primary rounded-0' type='button'>Жүктеу батырмасы</button>
			</div>
		</div>
	</form>
</div>

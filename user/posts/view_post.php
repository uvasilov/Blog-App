...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-light shadow blur">
	<h3><b>Пост турады деректер:</b></h3>
</div>
<style>
	.avatar-img{
      height: 3em;
				...
				<div class="container-fluid">
					<div class="d-flex w-100 align-items-center">
						...
						<div class="col-auto flex-shrink-1 flex-grow-1">
							...
							<div class="text-meted"><small>Жүктелген дата <i class="far fa-calendar"></i> <?= isset($date_created) ?  date("M d, Y h:i A", strtotime($date_created)): '' ?></small></div>
							</div>
						</div>
					</div>
					<hr>

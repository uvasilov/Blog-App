    ...
    <div class="d-flex w-100 px-4 h-100 align-items-center">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="card card-navy my-2">
          <div class="card-body">
            <p class="login-box-msg">Ақпараттарды енгізіңіз</p>
            <form id="ulogin-frm" action="" method="post">
              <div class="input-group mb-3">
                <input type="text" class="form-control" name="email" autofocus placeholder="Почта">
              ...
              <div class="row">
                <div class="col-8">
                  <a href="./register.php">Жаңа аккаунт жасау</a>
                </div>
                <!-- /.col -->
                <div class="col-4">
            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 'success') {
                        ...
                        var _frm = $('#ulogin-frm')
                        var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Қате құпия сөз</div>"
                        _frm.prepend(_msg)

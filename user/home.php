          ...
          <div class="container-fluid">
            <div class="d-flex w-100 align-items-center">
              ...
              <div class="col-auto flex-shrink-1 flex-grow-1">
                ...
                <div class="text-meted"><small>Жүктелген дата: <i class="far fa-calendar"></i> <?=  date("M d, Y h:i A", strtotime($row['date_created'])) ?></small></div>
                </div>
              </div>
            </div>
            <hr>
            ...
            <div class="mx-n4">
              ...
              <div class="d-flex align-items-center w-100">
                <div class="col-auto flex-shrink-1 flex-grow-1">
                  <textarea rows="2" class="form-control form-control-sm comment-field" data-id = '<?= $row['id'] ?>' placeholder="Пікіріңізді осында жазыңыз..."></textarea>
                </div>
                <div class="col-auto ">

<?php 
$user = $conn->query("SELECT * FROM member_list where id ='".$_settings->userdata('id')."'");
...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					<label for="password">Құпия сөзді жаңарту:</label>
					<input type="password" name="password" id="password" class="form-control" value="" autocomplete="off">
					<small><i>Құпия сөзді өзгерткіңіз келмесе, оны бос қалдырыңыз.</i></small>
				</div>
				<div class="form-group">
					...
					<div class="custom-file">
		              ...
		              <label class="custom-file-label" for="customFile">Файлды жүктеу</label>
		            </div>
				</div>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-user">Ақпаратты жаңарту</button>
				</div>
			</div>
		</div>
</div>
...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		start_loader()
		$.ajax({
			url:_base_url_+'classes/Users.php?f=save_member',

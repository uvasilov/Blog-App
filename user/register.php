      ...
      <form id="register-form" action="" method="post">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                    <label for="password" class="control-label">Құпия сөз</label>
                ...
                <div class="form-group">
                    <label for="cpassword" class="control-label">Кұпия сөзді растау</label>
                    <div class="input-group input-group-sm">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="custom-file">
		              ...
		              <label class="custom-file-label rounded-0" for="customFile">Файлды таңдау</label>
		            </div>
				</div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="row">
          <div class="col-8">
            <a href="./">Аккаунтынм бар.</a>
          </div>
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block">Тіркелу</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
